...
/* harmony import */ var components_dev_dot_content_mdx_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36578);
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20120);
/* harmony import */ var _utils_rewrite_tutorials_link__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(99670);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([unist_util_visit__WEBPACK_IMPORTED_MODULE_3__]);
unist_util_visit__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ /**
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20120);
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
...
/* harmony import */ var _hashicorp_platform_code_highlighting_rehype_surface_code_newlines__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(90998);
/* harmony import */ var _loaders_remote_content__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(91787);
/* harmony import */ var _hashicorp_remark_plugins__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(57752);
/* harmony import */ var _hashicorp_remark_plugins__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_hashicorp_remark_plugins__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var lib_env_checks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(62676);
/* harmony import */ var lib_env_checks__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(lib_env_checks__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var lib_remark_plugins_remark_plugin_remove_first_h1__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(30241);
/* harmony import */ var lib_get_static_paths_from_analytics__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(43888);
/* harmony import */ var components_outline_nav_utils_outline_items_from_headings__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(58180);
/* harmony import */ var lib_docs_add_branded_overview_sidebar_item__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(52487);
/* harmony import */ var lib_remark_plugins_rewrite_tutorial_links__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(60079);
/* harmony import */ var layouts_sidebar_sidecar_utils_prepare_nav_data_for_client__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(5220);
/* harmony import */ var components_breadcrumb_bar_utils_get_docs_breadcrumbs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(32749);
/* harmony import */ var components_sidebar_helpers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(12871);
/* harmony import */ var _utils_product_url_adjusters__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(51999);
/* harmony import */ var _utils_get_back_to_link__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(39158);
/* harmony import */ var _utils_get_deploy_preview_loader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(63181);
/* harmony import */ var _utils_get_custom_layout__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(19648);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_remark_plugins_remark_plugin_adjust_link_urls__WEBPACK_IMPORTED_MODULE_6__, lib_remark_plugins_rewrite_tutorial_links__WEBPACK_IMPORTED_MODULE_8__, _utils_get_deploy_preview_loader__WEBPACK_IMPORTED_MODULE_13__, lib_remark_plugins_remark_plugin_remove_first_h1__WEBPACK_IMPORTED_MODULE_15__]);
([lib_remark_plugins_remark_plugin_adjust_link_urls__WEBPACK_IMPORTED_MODULE_6__, lib_remark_plugins_rewrite_tutorial_links__WEBPACK_IMPORTED_MODULE_8__, _utils_get_deploy_preview_loader__WEBPACK_IMPORTED_MODULE_13__, lib_remark_plugins_remark_plugin_remove_first_h1__WEBPACK_IMPORTED_MODULE_15__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ // Third-party imports
 ...
 */ function getStaticGenerationFunctions({ product , basePath , productSlugForLoader =product.slug , basePathForLoader =basePath , baseName , additionalRemarkPlugins =[] , getScope =async ()=>({}) , mainBranch , navDataPrefix , options ={}  }) {
    ...
    const getLoader = (extraOptions)=>{
        if ((0,lib_env_checks__WEBPACK_IMPORTED_MODULE_7__.isDeployPreview)(productSlugForLoader)) {
            return (0,_utils_get_deploy_preview_loader__WEBPACK_IMPORTED_MODULE_13__/* .getDeployPreviewLoader */ .J)({
                basePath,
                currentRootDocsPath,
                loaderOptions: {
                    ...loaderOptions,
            ...
            return new _loaders_remote_content__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z({
                ...loaderOptions,
                ...extraOptions
            });
        }
    ...
    return {
        getStaticPaths: async ()=>{
            ...
            if ((0,lib_env_checks__WEBPACK_IMPORTED_MODULE_7__.isDeployPreview)() && !(0,lib_env_checks__WEBPACK_IMPORTED_MODULE_7__.isDeployPreview)(productSlugForLoader)) {
            ...
            const paths = await (0,lib_get_static_paths_from_analytics__WEBPACK_IMPORTED_MODULE_14__/* .getStaticPathsFromAnalytics */ .D)({
                limit: 9999 ?? 0,
        ...
        getStaticProps: async (ctx)=>{
            ...
            const loader = getLoader({
                ...
                remarkPlugins: [
					 ...
					 */ [
                        _hashicorp_remark_plugins__WEBPACK_IMPORTED_MODULE_5__.anchorLinks,
                        {
                            headings
                        }
                    ],
					 ...
					 */ lib_remark_plugins_remark_plugin_remove_first_h1__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z,
                    /**
					 ...
					 */ [
                        lib_remark_plugins_rewrite_tutorial_links__WEBPACK_IMPORTED_MODULE_8__/* .rewriteTutorialLinksPlugin */ .B,
                        {
                            contentType: "docs"
                        }
                    ],
					 ...
					 */ [
                        lib_remark_plugins_remark_plugin_adjust_link_urls__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z,
                        {
                            ...
                            urlAdjustFn: (0,_utils_product_url_adjusters__WEBPACK_IMPORTED_MODULE_12__/* .getProductUrlAdjuster */ .u)(product)
                        }
                    ]
                ],
                rehypePlugins: [
                    ...
                    _hashicorp_platform_code_highlighting_rehype_surface_code_newlines__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z
                ],
            ...
            if (h1Match) {
                ...
                pageHeading = {
                    id: slugify__WEBPACK_IMPORTED_MODULE_2___default()(fallbackHeading, {
                        lower: true
                    }),
            ...
            const outlineItems = (0,components_outline_nav_utils_outline_items_from_headings__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Z)(nonEmptyHeadings);
            /**
			 * Add fullPaths and auto-generated ids to navData
			 */ const { preparedItems: navDataWithFullPaths  } = await (0,layouts_sidebar_sidecar_utils_prepare_nav_data_for_client__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)({
                basePaths: [
                    product.slug,
                    basePath
                ],
			 ...
			 */ const menuItems = (0,lib_docs_add_branded_overview_sidebar_item__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z)(navDataWithFullPaths, {
                title: docsSidebarTitle,
                fullPath: docsBasePathFullPath,
                theme: product.slug
            });
            const docsSidebarLevel = {
                backToLinkProps: (0,_utils_get_back_to_link__WEBPACK_IMPORTED_MODULE_18__/* .getBackToLink */ .u)(currentRootDocsPath, product),
                levelButtonProps: {
			 ...
			 */ const sidebarNavDataLevels = [
                (0,components_sidebar_helpers__WEBPACK_IMPORTED_MODULE_11__/* .generateTopLevelSidebarNavData */ .Vz)(product.name),
                (0,components_sidebar_helpers__WEBPACK_IMPORTED_MODULE_11__/* .generateProductLandingSidebarNavData */ ._G)(product),
                docsSidebarLevel
            ];
            const breadcrumbLinks = (0,components_breadcrumb_bar_utils_get_docs_breadcrumbs__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z)({
                baseName,
                basePath,
			 ...
			 */ const finalProps = {
                ...
                metadata: {
                    ...
                    layout: (0,_utils_get_custom_layout__WEBPACK_IMPORTED_MODULE_19__/* .getCustomLayout */ .L)({
                        currentRootDocsPath,
                        frontMatter,
                        pathParts
                    })
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var content_supported_icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(71686);
/* harmony import */ var contexts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30694);
...
/* harmony import */ var slugify__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(73673);
/* harmony import */ var slugify__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(slugify__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var contexts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30694);
...
var __webpack_exports__ = __webpack_require__.X(0, [1441,3272,3225,7184,9146,3643,8030,453,7708,8942,3076,4175,1960,8835,5675,998,5102,3236,3613,7752,5152,7806,5703,131,4819,9670,7568,543,791,7628], () => (__webpack_exec__(82480)));
