...
__webpack_require__.d(__webpack_exports__, {
  "w": () => (/* binding */ getProduct)
});

// UNUSED EXPORTS: getProducts
...
;// CONCATENATED MODULE: ./src/lib/learn-client/api/product/formatting.ts
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
function formatting_formatProduct(product) {
    const { id , slug , name , description , docs_url  } = product;
    return {
        id,
        slug: types/* ProductOption */.wr[slug],
        name,
        description,
        docsUrl: docs_url
    };
...
;// CONCATENATED MODULE: ./src/lib/learn-client/api/product/index.ts
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
...
async function getProduct(idOrSlug) {
    ...
    // /products/:identifier
    const route = external_path_default().join(PRODUCT_API_ROUTE, identifier);
    const getProductRes = await (0,learn_client/* get */.U2)(route);
    if (getProductRes.ok) {
        const res = await getProductRes.json();
        return formatting_formatProduct(res.result);
    }
    const error = await (0,learn_client/* toError */.KC)(getProductRes);
    throw error;
}
// getProducts
...
// EXTERNAL MODULE: ./src/views/collection-view/helpers/index.ts + 4 modules
var helpers = __webpack_require__(81505);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "b": () => (/* binding */ fixBrandedCalloutUrls)
});

// EXTERNAL MODULE: ./src/lib/traverse.ts
var traverse = __webpack_require__(19421);
// EXTERNAL MODULE: ./src/lib/remark-plugins/rewrite-tutorial-links/utils/index.ts + 7 modules
var utils = __webpack_require__(20120);
// EXTERNAL MODULE: ./src/lib/remark-plugins/rewrite-tutorial-links/utils/rewrite-tutorials-link.ts
var rewrite_tutorials_link = __webpack_require__(99670);
;// CONCATENATED MODULE: ./src/views/product-tutorials-view/helpers/detect-and-reformat-learn-url.ts
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
 ...
 */ async function detectAndReformatLearnUrl(url) {
    TUTORIAL_MAP = await (0,utils/* getTutorialMap */.i0)();
    return (0,rewrite_tutorials_link/* rewriteTutorialsLink */.J)(url, TUTORIAL_MAP) ?? url;
}
/* harmony default export */ const detect_and_reformat_learn_url = (detectAndReformatLearnUrl);

;// CONCATENATED MODULE: ./src/views/product-tutorials-view/helpers/page-data/fix-branded-callout-urls.ts
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
 ...
 */ async function fixBrandedCalloutUrls(blocks) {
    const result = await (0,traverse/* traverse */.f)({
        blocks
    }, (_key, value)=>{
        // We only want to deal with branded callouts, with a defined cta.url
        const isBrandedCallout = (0,traverse/* isObject */.K)(value) && value.type === "BrandedCallout";
        if (!isBrandedCallout) {
            return value;
        }
        const { cta  } = value;
        if (!(0,traverse/* isObject */.K)(cta) || typeof cta.url !== "string") {
            return value;
        }
        // Fix the url
        const correctedUrl = detect_and_reformat_learn_url(cta.url);
        return {
            ...value,
            cta: {
                ...cta,
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ getProductPageContent)
});
...
// EXTERNAL MODULE: ./src/lib/gather-unique-values.ts
var gather_unique_values = __webpack_require__(19739);
// EXTERNAL MODULE: ./src/views/product-tutorials-view/helpers/get-inline-content.ts
var get_inline_content = __webpack_require__(43199);
// EXTERNAL MODULE: ./src/lib/strip-undefined-props.ts
var strip_undefined_props = __webpack_require__(81141);
;// CONCATENATED MODULE: ./src/views/product-tutorials-view/helpers/page-data/get-product-page-content.ts
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
 ...
 */ async function getProductPageContent(pageSlug) {
    ...
    const inlineTutorialSlugs = (await (0,gather_unique_values/* default */.Z)([
        "tutorialSlug",
        "tutorialSlugs"
    ], pageData)).map(String);
    const inlineCollectionSlugs = (await (0,gather_unique_values/* default */.Z)([
        "collectionSlug",
        "collectionSlugs"
    ], pageData)).map(String);
    // 2. Next we fetch the tutorial and collection data
    const inlineTutorials = inlineTutorialSlugs.length > 0 ? await (0,get_inline_content/* getInlineTutorials */.F)(inlineTutorialSlugs) : undefined;
    const inlineCollections = inlineCollectionSlugs.length > 0 ? await (0,get_inline_content/* getInlineCollections */.d)(inlineCollectionSlugs) : undefined;
    ...
    return (0,strip_undefined_props/* stripUndefinedProperties */.c)({
        pageData,
        inlineCollections,
        inlineTutorials
    });
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _get_product_page_content__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56023);
/* harmony import */ var _process_page_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(511);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_process_page_data__WEBPACK_IMPORTED_MODULE_1__]);
_process_page_data__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
...
/* harmony import */ var _fix_branded_callout_urls__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(70018);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_enrich_learn_data__WEBPACK_IMPORTED_MODULE_1__]);
_enrich_learn_data__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
...
/* harmony import */ var components_sidebar_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12871);
...
/* harmony export */ });
/* harmony import */ var lib_learn_client_api_collection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73450);
/* harmony import */ var lib_learn_client_api_product__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6282);
...
/* harmony import */ var views_collection_view_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(81505);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_helpers_page_data__WEBPACK_IMPORTED_MODULE_5__]);
_helpers_page_data__WEBPACK_IMPORTED_MODULE_5__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
/**
 * Copyright (c) HashiCorp, Inc.
 * SPDX-License-Identifier: MPL-2.0
 */ 
...
var __webpack_exports__ = __webpack_require__.X(0, [1441,3272,7791,7184,9146,3643,2067,453,7152,9231,5703,1505,5623,9670,4884,8418,1836,791,6415,9565,197,5587,4717], () => (__webpack_exec__(90424)));
